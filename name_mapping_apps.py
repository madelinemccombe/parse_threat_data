...
def cli(filename):
    ...
    output_filename = 'metrics_threat_output/metrics_threat_apps'
    skip_fields = ['_id','_index','_score','_type', 'date',"is-aperture",'is-saas','risk','subcategory','used-by-malwared']
    int_fields = [
        "metrics.threat.application.count"
        ]
    float_fields = []
